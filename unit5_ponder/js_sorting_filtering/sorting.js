...
function searchList(array, query) {
...
function searchListObject(array, query) {
    ...
    const filteredArray = array.filter(searchCallback);
    const sortedArray = filteredArray.sort((a,b) => a.distance - b.directions);
    return sortedArray;
}

const simpleList = ["oranges", "grapes", "lemons", "apples", "Bananas", "watermelons", "coconuts", "broccoli", "mango"];

console.log(searchListObject(hikes, "al"));